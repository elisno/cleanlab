...
class KerasWrapper:
    """Base class for the Keras model APIs."""

    def __init__(self, compile_kwargs: dict = {"loss": DEFAULT_LOSS}):
...
class KerasWrapperModel(KerasWrapper):
...
class KerasWrapperSequential(KerasWrapper):
    ...
    compile_kwargs: dict, default = {"loss": DEFAULT_LOSS}
        Dict of optional keyword arguments to pass into ``model.compile()`` for declaring loss, metrics, optimizer, etc.
    """
